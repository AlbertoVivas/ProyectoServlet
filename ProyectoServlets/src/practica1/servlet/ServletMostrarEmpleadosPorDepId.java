 ...
 * 
 */
public class ServletMostrarEmpleadosPorDepId extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)throws ServletException, IOException {
		...
		log.debug("doGet ServletMostrarEmpleadosPorDepId"); 
		...
		req.getRequestDispatcher("SelectDepartment.jsp").forward(req, resp);
	}
}
